...
<head>
    ...
    <title>@yield('title', 'Elektron Qabulxona') — SIES.UZ</title>
    ...
    <style>
        ...
        .step-connector.done::before { background: #16a34a; }
    </style>
...
<body class="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
    ...
    <header class="bg-primary-700 shadow-md">
        <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
            ...
            <a href="{{ route('appeals.index') }}" class="flex items-center gap-3 group">
                ...
                <div class="leading-tight">
                    <p class="text-white font-bold text-sm sm:text-base tracking-wide group-hover:opacity-90 transition">SIES.UZ</p>
        ...
        <div x-data="{ open: false }" @toggle-menu.window="open = !open"
            ...
            <a href="{{ route('appeals.index') }}" class="block px-3 py-2 rounded text-primary-100 hover:bg-primary-700">Bosh sahifa</a>
            <a href="{{ route('appeals.create') }}" class="block px-3 py-2 rounded text-primary-100 hover:bg-primary-700">Murojaat yuborish</a>
            <a href="{{ route('tracking.index') }}" class="block px-3 py-2 rounded text-primary-100 hover:bg-primary-700">Murojaatni kuzatish</a>
        </div>
    </header>
    ...
    <footer class="bg-gray-800 text-gray-300 mt-auto">
        <div class="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 sm:grid-cols-3 gap-8 text-sm">
            ...
            <div>
                <h3 class="text-white font-semibold mb-3 text-base">SIES.UZ Elektron Qabulxona</h3>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('appeals.index') }}" class="text-gray-400 hover:text-white transition">Murojaat yuborish</a></li>
                    <li><a href="{{ route('tracking.index') }}" class="text-gray-400 hover:text-white transition">Murojaatni kuzatish</a></li>
                    <li><a href="https://sies.uz" target="_blank" class="text-gray-400 hover:text-white transition">Asosiy sayt →</a></li>
                </ul>
            </div>
        </div>

        <div class="border-t border-gray-700 px-4 py-4 text-center text-xs text-gray-500">
            &copy; {{ date('Y') }} SIES.UZ — Barcha huquqlar himoyalangan.
        </div>
    </footer>
